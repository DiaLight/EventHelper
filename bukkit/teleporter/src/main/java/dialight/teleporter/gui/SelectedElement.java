...
public class SelectedElement extends NamedSetElement<UuidPlayer, UUID> {

    @NotNull private final Teleporter proj;
    @NotNull private final SelectedPlayers selected;

    public SelectedElement(Teleporter proj, SelectedPlayers selected) {
    ...
    @Override public void onViewersNotEmpty() {
        selected.toUuidPlayers().forEach(this::add);
