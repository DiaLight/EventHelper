...
public class SelectedLayout extends NamedSetLayout<OfflinePlayer, UUID> {
    ...
    public SelectedLayout(Teleporter proj, SelectedPlayers selected) {
    ...
    @Override public void onViewersNotEmpty() {
        selected.toOfflinePlayers().forEach(this::add);
