...
public class CachedPageElement<T> extends DataElement<T> {

    private static final class BackedSlot<T> implements SlotUsage {

        private final CachedPageElement<T> layout;
        public final Slot slot;
        public final T data;

        public BackedSlot(CachedPageElement<T> layout, Slot slot, T data) {
            this.layout = layout;
            this.slot = slot;
            this.data = data;
        }
    ...
    public CachedPageElement(IndexCache cache) {
