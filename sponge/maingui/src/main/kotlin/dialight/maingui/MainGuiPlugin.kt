...
import dialight.maingui.gui.MainGui
import dialight.maingui.gui.MainGuiItem
...
@Plugin(id = "maingui")
class MainGuiPlugin @Inject constructor(
    ...
    fun onServerStart(event: GameStartedServerEvent) {
        ...
        registerToolItem(tool.id, MainGuiItem(this))
        registerCommands()
